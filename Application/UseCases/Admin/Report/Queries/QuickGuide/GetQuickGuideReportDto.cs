...
{
    public class GetQuickGuideReportDto : BaseDto
    {
        public QuickGuideReportData Data { set; get; }
    }

    public class QuickGuideReportData
    {
    ...
    public class MaterialVisitItem : BaseDtoData, IHaveCustomMapping
    {
        ...
        {
            configuration.CreateMap<Domain.Entities.GuideMaterial, MaterialVisitItem>()
        ...
        public static int ResolveTotalUserVisited(ISFDDBContext context, Domain.Entities.GuideMaterial source)
        {
