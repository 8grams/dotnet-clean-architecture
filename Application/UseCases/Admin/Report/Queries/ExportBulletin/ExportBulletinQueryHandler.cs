...
{
    public class ExportBulletinQueryHandler : IRequestHandler<ExportBulletinQuery, ExportBulletinDto>
    {
        ...
        public ExportBulletinQueryHandler(ISFDDBContext context, IMediator mediator, IUploader uploader, IWebHostEnvironment env, Utils utils)
        {
            _context = context;
            _mediator = mediator;
            _uploader = uploader;
        ...
        public async Task<ExportBulletinDto> Handle(ExportBulletinQuery request, CancellationToken cancellationToken)
        {
            ...
            var path = Utils.GetUploadLocation("export", "export_bulletin.csv");
            ...
            var a = await Task.FromResult<ExportBulletinDto>(null);
            return new ExportBulletinDto
            {
                Success = true,
                Message = "Export bulletin has been successfully executed",
                Data = new ExportBulletinData
                {
