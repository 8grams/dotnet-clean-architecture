...
namespace SFIDWebAPI.Application.UseCases.Admin.Bulletin.Models
{
    public class BulletinData : BaseDtoData, IHaveCustomMapping
    {
        ...
        public static bool Resolve(ISFDDBContext context, Domain.Entities.Bulletin source)
        {
        ...
        public static int ResolveTotalUserViewed(ISFDDBContext context, Domain.Entities.Bulletin source)
        {
