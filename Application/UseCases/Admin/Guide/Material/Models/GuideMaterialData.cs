...
namespace SFIDWebAPI.Application.UseCases.Admin.Guide.Material.Models
{
    public class GuideMaterialData : BaseDtoData, IHaveCustomMapping
    {
        ...
        public static File Resolve(AutoMapperProfile profile, Domain.Entities.GuideMaterial source)
        {
        ...
        public static bool Resolve(ISFDDBContext context, Domain.Entities.GuideMaterial source)
        {
        ...
        public static int ResolveTotalUserViewed(ISFDDBContext context, Domain.Entities.GuideMaterial source)
        {
